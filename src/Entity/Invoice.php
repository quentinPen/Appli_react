...
class Invoice
{
     ...
     * @Assert\NotBlank(message="La date d'envoie doit etre présente")
     */
    private $sentAt;
     ...
     * @Groups({"invoices_read", "customers_read", "invoices_subresource"})
     * @Assert\NotBlank(message="Staut obligatoire")
     * @Assert\Choice(choices={"SENT", "CANCELLED", "PAID"}, message="Le statut doit être déclaré")
     */
    private $status;
